...
where:
-$\varepsilon_t$ are the shocks,
-$\sigma_t$ is the conditional volatility,
-$\omega$ is the constant term,
-$\alpha_1$ represents the ARCH effect,
-$\beta_1$ represents the GARCH effect.
...
-$\mu_h$ is the baseline intensity,
-$\alpha_h$ quantifies the impact of past events,
-$\beta_h$ is the decay rate.
...
-$N$ is the number of extreme events.
...
where:
-$ \varepsilon_t$ are the shocks (unexpected returns),
-$ \sigma_t$ is the conditional volatility,
-$ \omega$ is the constant term,
-$ \alpha_1$ represents the ARCH effect (the impact of the previous period’s shock),
-$ \beta_1$ represents the GARCH effect (the persistence of past volatility).
