...
Here we can see an much more complete and [interactive mindmap: (if the HTML doesn´t work, see the pic below)](https://whimsical.com/refined-thesis-proposal-mindmap-7PmxpSyBtJQ451hP7BxCTC)

![](https://raw.githubusercontent.com/pibicagrofinance/site/main/RefinedThesisProposalMindmap.png)
